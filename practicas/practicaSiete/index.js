...
// Operators
const potBtn = document.getElementById('calculator__potency');
const fibBtn = document.getElementById('calculator__fibonacci');
...
function result() {
  ...
  }else if(operator === 'pot'){
    resultNumber = Math.pow(firstNumber,secondNumber)
  }else if(operator === 'fib'){
      
      let n1 = 0, n2 = 1, nextTerm=0;
      while (nextTerm <= firstNumber) 
      {
            n1 = n2;
            n2 = nextTerm;
            nextTerm = n1 + n2;
      }
    resultNumber = nextTerm
...
potBtn.addEventListener('click',pot);
